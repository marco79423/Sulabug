...
import ComicInfo from '../../../domain/downloader/entities/ComicInfo'
import {ComicInfoFactory} from '../../../domain/downloader/interfaces/factories'
import {ComicInfoStorageRepository, ConfigRepository} from '../../../domain/downloader/interfaces/repositories'
import {FileAdapter} from '../../../domain/downloader/interfaces/adapters'
...
export default class ComicInfoStorageRepositoryImpl implements ComicInfoStorageRepository {
  ...
  public constructor(
    @inject(downloaderTypes.FileAdapter) fileAdapter: FileAdapter,
    @inject(downloaderTypes.ComicInfoFactory) comicInfoFactory: ComicInfoFactory,
    @inject(downloaderTypes.ConfigRepository) configRepository: ConfigRepository,
  ) {
