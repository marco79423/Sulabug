...
describe('DownloadComicService', () => {
  it('will handle download task to download comic', async () => {
    ...
    const downloadComicService = new DownloadComicService(sfComicDownloadAdapter, downloadTaskRepository)
    ...
    expect(downloadTaskRepository.delete).toBeCalledWith(downloadTask.identity)
  })
})
